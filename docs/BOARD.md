...
| :----------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------- | :---------- | :----- | :-- | :------------------------------------------------- |
| [STORY-3: Employee & Vehicle Schedules](issues/story_3_employee_vehicle.md) <br> `priority:p1`    |                                                                                                  | [STORY-2: Core Event Lifecycle (GH-#2)](https://github.com/LeulTew/dreamlux-erp/issues/2) <br> `priority:p0` |        |     | [TASK-0: Base Setup & Spec Cleaning] `priority:p0` <br> [STORY-1: UI & Contrast Revamp (GH-#1)](https://github.com/LeulTew/dreamlux-erp/issues/1) <br> `priority:p0` |
