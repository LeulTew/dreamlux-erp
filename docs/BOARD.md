...
| :----------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------- | :---------- | :----- | :-- | :------------------------------------------------- |
| [STORY-3: Employee & Vehicle Schedules](issues/story_3_employee_vehicle.md) <br> `priority:p1`    | [STORY-1: UI & Contrast Revamp](issues/story_1_ui_revamp.md) <br> `priority:p0`                  |             |        |     | [TASK-0: Base Setup & Spec Cleaning] `priority:p0` |
| [STORY-4: Expenses Entry & Approvals](issues/story_4_expenses_reconciliation.md) <br> `priority:p1` | [STORY-2: Core Event Lifecycle](issues/story_2_event_lifecycle.md) <br> `priority:p0`            |             |        |     |                                                    |
