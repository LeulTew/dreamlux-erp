...
export const ROLE_PERMISSION_SEEDS: Record<string, string[]> = {
  ...
  owner: ["*"],
  system_manager: ["*"],
  inventory_controller: ["assets:read", "assets:write", "assets:reconcile", "assets:delete", "event_allocations:write", "vehicles:read", "exports:read", "offices:read"],
  inventory_officer: ["assets:read", "assets:write", "assets:reconcile", "event_allocations:write", "vehicles:read", "exports:read", "offices:read"],
  ops_manager: [
    "assets:read",
    "events:read",
    "events:write",
  ...
  event_manager: ["assets:read", "events:read", "events:write", "events:proposals:write", "event_allocations:write", "event_checklist:write", "event_assignments:write", "vehicle_assignments:write", "vehicles:read", "trips:create", "expenses:write"],
