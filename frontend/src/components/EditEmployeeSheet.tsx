                ...
                <div className="sm:col-span-1 flex flex-col items-center justify-center gap-3 bg-card-alt/30 p-4 rounded-xl border border-border/50">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="px-2.5 py-1 bg-primary/10 text-primary text-[9px] font-bold rounded-lg hover:bg-primary/20 transition-all whitespace-nowrap"
                    >
                      New Photo
                    </button>
                    <button
                      ...
                      className="px-2.5 py-1 bg-card-alt border border-border text-muted text-[9px] font-bold rounded-lg hover:bg-border transition-all whitespace-nowrap"
                    >
                      Upload
                    </button>
                  </div>
                ...
                <div className="sm:col-span-2 grid grid-cols-2 gap-4 bg-card-alt/30 p-4 rounded-xl border border-border/50">
                  <div className="space-y-2 flex flex-col justify-between">
                    ...
                    <div
                      ...
                      className="relative aspect-[1.6/1] w-full rounded-xl border-2 border-dashed border-border overflow-hidden cursor-pointer bg-card-alt/50 hover:border-primary/30 transition-all flex-1 flex items-center justify-center min-h-[96px]"
                    >
                      {frontPreview ? (
                        ...
                        <div className="flex flex-col items-center justify-center gap-1.5 opacity-30 text-center">
                          ...
                          <span className="text-[9px] font-black italic">Upload Front</span>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2 flex flex-col justify-between">
                    ...
                    >
                      {backPreview ? (
                        ...
                        <div className="flex flex-col items-center justify-center gap-1.5 opacity-30 text-center">
                          <HiIdentification className="w-6 h-6 text-muted" />
                          <span className="text-[9px] font-black italic">Upload Back</span>
                        </div>
                      )}
                    </div>
                  </div>
                    ...
                    {isAddingDepartment ? (
                      ...
                      <>
                        <Select
                          ...
                          className="flex-1"
                        />
                        <button type="button" onClick={() => setIsAddingDepartment(true)} className="w-10 h-10 rounded-full bg-primary text-on-primary hover:bg-primary-dark transition-all shadow-premium flex items-center justify-center shrink-0">
                          <HiPlus className="w-4 h-4" />
                        </button>
                      </>
                    )}
