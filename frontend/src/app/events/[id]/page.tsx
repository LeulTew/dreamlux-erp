                  ...
                  {canWriteAllocations && allocations.length > 0 && (
                    <div className="sticky bottom-3 mt-4 flex justify-end border-t border-border bg-card pt-4">
                      <Button
                        ...
                        className="min-h-12 w-full rounded-md bg-primary px-5 text-xs font-black uppercase tracking-widest text-on-primary transition-all active:scale-[0.98] md:hover:opacity-90 sm:w-auto"
                      >
