    ...
    <AuthLayout>
      <div className="page-container-sm pt-4 md:py-8 px-4 sm:px-6 md:px-8">
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 md:mb-8">
          ...
          <Link href="/hr/salary-levels/trash" className="flex items-center gap-2 h-10 px-4 bg-danger/10 text-danger rounded-xl font-semibold text-xs [@media(hover:hover)]:hover:bg-danger/20 transition-all active:scale-[0.98] shadow-sm border border-danger/20">
