...
export async function installSyntheticRealtime(
  context: BrowserContext, baseURL: string, unexpected: string[],
  websocketOrigin: "ws://127.0.0.1:54321" | "ws://127.0.0.1:54335" = "ws://127.0.0.1:54335",
) {
