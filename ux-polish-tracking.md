...
| #85 | HR dashboard for workforce, payroll, and staffing readiness | [PR #100](https://github.com/LeulTew/dreamlux-erp/pull/100) and [PR #103](https://github.com/LeulTew/dreamlux-erp/pull/103) completed; includes KPI metric cards, document gaps, exceptions table with click-to-edit, dynamic payroll redaction. | Complete. 15/15 Vitest unit tests and 6/6 Playwright E2E tests pass cleanly. Gated behind hr:read / payroll:read. |
