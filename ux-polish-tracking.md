...
| [#109](https://github.com/LeulTew/dreamlux-erp/issues/109) | Weekly and monthly Hisab rollup with non-event operational expenses | [PR #117](https://github.com/LeulTew/dreamlux-erp/pull/117) merged; issue closed after finance_operational_expenses table + remote migration, finance permission slugs, /finance rollup/ledger/export routes with transactional audit logs, /hr/finance/hisab page, 19 backend + 6 UI tests, and 6/6 desktop/mobile Playwright scenarios. |
