...
for (const name of Object.keys(process.env)) {
  if (/^(?:DATABASE|DIRECT_DATABASE|PG|POSTGRES|PGRST|SUPABASE|NEXT_PUBLIC_|JWT|ADMIN_PASSWORD|DREAMLUX_NATIVE_|DREAMLUX_TEST_|DREAMLUX_BACKUP_|DREAMLUX_STORAGE_)/i.test(name)) delete process.env[name];
}
